...
public class VideoServlet extends HttpServlet {
    ...
    public void init() throws ServletException {
        ...
        this.basePath = new String(this.getClass().getClassLoader().getResource("files/video.mp4").getPath().replaceAll("video.mp4", "")); //getInitParameter("basePath");
